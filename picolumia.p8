    ...
    blocks_clearing=cocreate(function()
        ...
        if combo_size > 1 then
            ...
            if combo_size > 3 then
                medium_combo_reward_sound()
            else
                small_combo_reward_sound()
            end
        end
...
function small_combo_reward_sound()
    local combo_sounds={13,14}
    sfx(combo_sounds[flr(rnd(#combo_sounds))+1])
end

function medium_combo_reward_sound()
    local combo_sounds={12}
    sfx(combo_sounds[flr(rnd(#combo_sounds))+1])
end

function large_combo_reward_sound()
    local combo_sounds={15}
    sfx(combo_sounds[flr(rnd(#combo_sounds))+1])
end
...

__music__
04 00024444
04 0a084344
04 02034344
